...
export default function UpdateAadhaar() {
  ...
  useEffect(() => {
    ...
    async function loadData() {
      const dbData = await getSubService('aadhaar', 'update-aadhaar')
      setData(dbData)
    }
    loadData()
  }, [navigate])
  ...
  return (
    <>
      ...
      <div className="container" style={{ paddingBottom: '80px' }}>
        <button className="back-link" onClick={() => navigate('/process/aadhaar')} style={{ marginBottom: '24px' }}>
          ← Back to Aadhaar Services
        </button>

        <div className="page-header">
          <h1>Update Aadhaar</h1>
          <p>Modify your demographic or biometric details</p>
        </div>

        {data && data.steps && (
          <div style={{ marginBottom: '24px' }}>
            <h3 style={{ marginBottom: '16px', fontSize: '18px' }}>Step-by-step instructions</h3>
