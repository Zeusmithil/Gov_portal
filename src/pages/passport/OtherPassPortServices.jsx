...
export default function DrivingSchool() {
  ...
  useEffect(() => {
    ...
    async function loadData() {
      const dbData = await getSubService('passport', 'other-services')
      setData(dbData)
    }
    loadData()
  }, [navigate])
  ...
  return (
    <>
      ...
      <div className="container" style={{ paddingBottom: '80px' }}>
        <button
          className="back-link"
          onClick={() => navigate('/process/passport')}
          style={{ marginBottom: '24px' }}
        >
          ← Back to Passport Services
        </button>

        <div className="page-header">
          <h1>Other Passport Services</h1>
          <p>Apply for Other Passport Services</p>
        </div>
